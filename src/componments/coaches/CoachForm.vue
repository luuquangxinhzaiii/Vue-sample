<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control" :class="{invalid: !description.isValid}">
        ...
        <textarea id="description" cols="30" rows="5" v-model.trim="description.val"  @blur="clearValidity('description')"></textarea>
    ...
    <p v-if="!formIsValid">Please fig the above errors and submit again!</p>
